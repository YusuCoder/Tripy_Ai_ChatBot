...
from main import get_travel_agent, get_system_prompt, create_new_chat_session, delete_chat_session, get_all_chat_sessions, get_chat_history_for_session, get_session_history, LANGFUSE_ENABLED
...
def main():
    ...
    # Display Langfuse status in sidebar
    with st.sidebar:
        if LANGFUSE_ENABLED:
